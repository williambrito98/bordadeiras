...
class NoticiasController extends Controller
{
    ...
    public function index()
    {
        ...
        $posts[] = (object)[
            ...
            'image_url' => 'https://www.bordadeirasdobrasil.com.br/img/Fotógrafo Gabriehl Oliveira--.JPG',
        ...
        $posts[] = (object)[
            ...
            'image_url' => 'https://www.bordadeirasdobrasil.com.br/img/Fotógrafo Gabriehl Oliveira__-.jpg',
